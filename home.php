				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center">
					    		<h3> Vec ste glasali!</h3>
					    		<a href="#view" data-toggle="modal" class="btn btn-flat btn-primary btn-lg">Pregledaj glasacki listic</a>
					    	</div>
				    		<?php
				    	}
				    	else{
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		...
				        		?>
				        		<div class="text-center">
					        		<button type="button" class="btn btn-success btn-flat" id="preview"><i class="fa fa-file-text"></i> Pregled</button> 
					        		<button type="submit" class="btn btn-primary btn-flat" name="vote"><i class="fa fa-check-square-o"></i> Glasaj</button>
					        	</div>
				        	</form>
				        	<!-- End Voting Ballot -->
				    		<?php
